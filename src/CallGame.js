...
class CallGame{
    ...
    findCreepersForRole(role){
        ...
        return _.filter(Game.creeps, (creep) => creep.memory.role == role) && _.filter(Game.creeps, (creep) => creep.ticksToLive > 0) && _.filter(Game.creeps, (creep) => creep.ticksToLive < 1500);
    }
